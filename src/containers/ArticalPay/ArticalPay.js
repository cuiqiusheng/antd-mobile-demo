...
class ArticalPay extends Component {
  constructor(props) {
    super(props);
    this.state ={};
    ...
    return (
      <div className={style.wrapper}>
        ...
        <div className={style.articalBox}>
          ...
          <p className={style.artical}>据英国路透社8月2日报道，美国司法部特别检察官穆勒团队的发言人证实，一名前美国司法部官员将成为穆勒团队的最新成员。该团队主要负责调查俄罗斯干涉2016年美国大选一案。
          ...
          穆勒在5月份被司法部委任为特别检察官，负责调查在大选中特朗普和俄罗斯之间的可能存在的串通以及其他事务。美国国会委员会也同样在调查这些事务......</p>
        </div>
        <div className={style.btnBox}>
          <Button type="ghost" className={style.btn}>支付10元，继续阅读</Button>
        </div>
        <p className={style.tip}>还有90%的精彩内容，购买继续阅读</p>
